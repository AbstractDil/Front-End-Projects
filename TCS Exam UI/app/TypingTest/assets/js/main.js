...
const examName = 'Dest Typing For SSC CGL Examination, 2023';
document.getElementById('examName').innerHTML = examName;
document.getElementById('examName').title = "Name of Exam : " + examName;
document.title = examName + "MathHub Online Examination System " ;

const SubjectName = ' Dest Typing'; 
document.getElementById('displaySubject').innerHTML = SubjectName;
document.getElementById('displaySubject').title = "Subject : " + SubjectName;

const CandidateName = 'John Due';
document.getElementById('Candidate_Name').innerHTML = CandidateName;
document.getElementById('Candidate_Name').title = "Your name : " + CandidateName;


const CandidateRNo = '1234567890';
document.getElementById('Candidate_RollNo').innerHTML = CandidateRNo;
document.getElementById('Candidate_RollNo').title = "Your rollno : " + CandidateRNo;
...
if(page == "2"){
  ...
  $("#btnNext2").click(function () {
    ...
    if($("#disclaimer").is(":checked") && $("#defaultLanguage").val() != "-- Select --"){

      //alert("Assessment Page Loading");
      window.location.href= "ssc-typing-test.html?token_key=" + token_key() ;
      //return true;

    }

    else{
      alert(" *** MESSAGE FROM SERVER **** \n Please select your default language and check the disclaimer.");
